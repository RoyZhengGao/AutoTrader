		...
		<div class="top" >
			...
			<!-- Nav -->
					...
					<li ><a href="#portfolio" id="portfolio-link"
						class="skel-panels-ignoreHref" ><span style="font-size:25px;font-color:black;">Gallery&nbsp;&nbsp;<i class="photo icon"></i></span></a></li>
					<li><a href="#about" id="about-link"
						class="skel-panels-ignoreHref"><span style="font-size:25px;font-color:black">Sentimental Analysis&nbsp;&nbsp;<i class="edit icon"></i></span></a></li>
					<li><a href="#contact" id="contact-link"
						class="skel-panels-ignoreHref"><span style="font-size:25px;font-color:black">Hot Tweets&nbsp;&nbsp;<i class="twitter icon"></i></span></a></li>
				</ul>
			</nav>
			<br/>
			<div id="rating" style="text-align:center">
				...
				<div>
					...
					<div style="margin-left:125px" id="gaugechart_div" style="height:100px;width:100px"></div>
				</div>
			</div>
					    ...
					    <div class="column">
					      <div class="ui raised segment" style="width:700px">
					        <div class="ui red ribbon label" style="font-size:20px">Sentiment by Percent</div>
					        	<div id="piechart_div" style="width:500px; height: 350px;"></div>
					       	...
					       	<div class="ui red ribbon label" style="font-size:20px">Sentiment by Count</div>
					        	<div id="barchart_div" style="width:550px; height: 280px;margin-bottom:10px;"></div>	
					      </div>
					    </div>
					    <div class="column" >
